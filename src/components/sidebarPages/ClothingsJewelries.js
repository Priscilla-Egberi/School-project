...
function ClothingsJewelriesList() {
    const filteredClothingsJewelries = Img.filter((item) => item.category === 'Clothings and Jewelries');
  return (
    <>
...
export default ClothingsJewelriesList
