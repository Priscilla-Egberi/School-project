...
<img src={props.detail} alt="Basic Tee in black." className="h-full w-full object-cover object-center lg:h-full lg:w-full" onClick={()=>{AddItems(props.name, props.amount, props.id)}}/>
</div></div>
      <CardBody>
