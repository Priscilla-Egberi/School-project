...
function SideBar() {
  ...
  return (
    <section onClick={()=>{setCheck(true)}}  id="openSidebarHere" className={`side-bar h-full md:hidden ${check? "":'openSidebar'} font-semibold h-full bg-white flex flex-col justify-between border-r-gray border-2`}>
        <div>
