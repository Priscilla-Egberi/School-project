  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center">
        {/* card 1 */}
        <div className="p-5 flex flex-col justify-center items-center rounded shadow-lg mr-5">
        ...
        {/* card 2 */}
        <div className="p-5 flex flex-col justify-center items-center rounded shadow-lg ml-5">
            <div className='rounded-full bg-my-lightorange p-3'>
