  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center">
        {/* card 1 */}
        <div className="p-5 flex flex-column justify-center items-center rounded drop-shadow mr-5">
        ...
        {/* card 2 */}
        <div className="p-5 flex flex-column justify-center items-center rounded drop-shadow ml-5">
            <div className='rounded-full bg-my-lightorange p-3'>
