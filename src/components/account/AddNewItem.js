...
function AddNewItem() {
  return (
    <div>
      ...
      <h1 className="mt-7 text-xl font-bold tracking-tight text-gray-900 text-center">What do you want to add?</h1>
      <div className="flex flex-row justify-center">
        {/* card 1 */}
        <div className="max-w-sm p-5 flex flex-col justify-center items-center rounded shadow-lg mr-5">
            ...
            <h1 className="text-xl font-bold tracking-tight text-gray-900 text-center">Sell Product</h1>
            <p className="text-center">Sell both new and fairly used products of any kind</p>
        </div>
        {/* card 2 */}
        <div className="max-w-sm p-5 flex flex-col justify-center items-center rounded shadow-lg ml-5">
            <div className='rounded-full bg-my-lightorange p-3'>
            ...
            <h1 className="text-xl font-bold tracking-tight text-gray-900 text-center">Offer Service</h1>
