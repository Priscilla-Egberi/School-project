...
<div className="h-screen md:flex">
	<div
		...
		<div>
			...
			<Link to="/signup" className="block w-28 bg-white text-orange-800 mt-4 py-2 rounded-2xl font-bold mb-2">Sign up</Link>
		</div>
	...
	<div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form className="bg-white">
			...
			<p className="text-sm font-normal text-gray-600 mb-7">You don't have an account? <Link to="/signup" className="text-my-orange hover:text-black cursor-pointer">Sign up</Link></p>
			{/* <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
				...
				<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Reg Number" />
      </div> */}
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none"
							viewBox="0 0 24 24" stroke="currentColor">
